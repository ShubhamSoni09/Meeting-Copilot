...
const DEFAULT_SETTINGS: AppSettings = {
  ...
  detailedAnswerSystemPrompt: [
    ...
    "Keep the answer concise and live-meeting friendly (typically 80-140 words).",
    ...
    "If information is missing, say 'Not available in current transcript' once, then ask one targeted follow-up question and suggest one concrete next step.",
  ...
  chatSystemPrompt: [
    ...
    "If a requested detail is missing, say 'Not available in current transcript' once, ask one concise follow-up, and include one practical next step.",
    "When context is missing, keep the answer compact but complete (usually 55-95 words), and avoid generic filler.",
